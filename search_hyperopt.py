...
def search(training_data, max_runs, epochs, metric, algo, seed):
    """
        ...
        def eval(params):
            ...
            with mlflow.start_run(nested=True) as child_run:
                p = mlflow.projects.run(
                    uri="https://github.com/mlflow/mlflow/tree/master/examples/hyperparam",
                    entry_point="train",
    ...
    with mlflow.start_run() as run:
        ...
        # )(params=[0])
        best = fmin(
            fn=new_eval(epochs, experiment_id, _inf, _inf, _inf),
            space=space,
